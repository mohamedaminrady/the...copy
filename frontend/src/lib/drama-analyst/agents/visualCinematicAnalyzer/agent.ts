...
export const VISUAL_CINEMATIC_ANALYZER_AGENT_CONFIG: AIAgentConfig = {
  ...
  description:
    "الوحدة 5 - بصيرة السينما الذكية: محلل بصري سينمائي متطور يستخدم تقنيات الرؤية الحاسوبية مع نماذج فهم السرد البصري لتحليل وتفسير العناصر السينمائية المضمنة في النص، مزود بخوارزميات تحليل الإخراج وتقييم القابلية للتصوير، مع قدرات كشف الرمزية البصرية وتحليل الأجواء الإخراجية.",
